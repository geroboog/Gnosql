		...
		init: function(config){
            ...
            var tempValue2 ='';
		    	for(var i=0; i<_this.wheel.length; i++){
		    		i==_this.wheel.length-1 ? _this.getValue(i)<10 ? tempValue += "0"+_this.getValue(i):tempValue += _this.getValue(i) : _this.getValue(i)<10 ? tempValue += "0"+_this.getValue(i)+"-":tempValue += _this.getValue(i)+"-";
                    _this.getValue(i)<10 ? tempValue2 += "0"+_this.getValue(i):tempValue2 += _this.getValue(i);
		    	}
		    	_this.trigger.innerHTML = tempValue;
                _this.trigger.value = tempValue2;
